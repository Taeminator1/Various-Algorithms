...
//  선호도 반영 x
//print("Total washed number: \(advancedLaundrySimulator1(stuffNumber: 10, term: 7, repeatNumber: 100, possibility: 0.8, isRandom: true).reduce(0) { $0 + $1.washedNumber })")

//  선호도 반영 o:
//  - 전혀 사용하지 않는 옷은 없어짐
//  - 선호도에 따른 사용 불균일이 어느 정도 사라졌지만, 여전히 심함
//print("Total washed number: \(advancedLaundrySimulator1(stuffNumber: 10, term: 7, repeatNumber: 100, possibility: 0.8, isRandom: false).reduce(0) { $0 + $1.washedNumber })")
